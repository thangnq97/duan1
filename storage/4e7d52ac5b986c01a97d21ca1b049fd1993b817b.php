            ...
            <table class="w-full rounded">
                ...
                <tbody>
                    <?php $__currentLoopData = $bills; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bill): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            <td class="border border-black text-center px-3 py-4"><?php echo e($bill->id); ?></td>
                            <td class="border border-black text-center px-3 py-4"><?php echo e($bill->fullname); ?></td>
                            <td class="border border-black text-center px-3 py-4"><?php echo e($bill->phone); ?></td>
                            <td class="border border-black text-center px-3 py-4"><?php echo e($bill->address); ?></td>
                            <td class="border border-black text-center px-3 py-4"><?php echo e($bill->total_price); ?></td>
                            <td class="border border-black text-center px-3 py-4"><?php echo e($bill->status); ?></td>
                            <td class="border border-black text-center px-3 py-4"><?php echo e($bill->create_at); ?></td>
                            <td class="border border-black text-center px-3 py-4"><button class="text-[14px] text-white font-[400] bg-[#1E74A4] rounded h-[30px] w-[70px] hover:opacity-90"><a class="" href="./user-bill-detail?id=<?php echo e($bill->id); ?>">Detail</a></button></td>
                        </tr>
...
</html><?php /**PATH C:\xampp\htdocs\duan1\app\views/user/history.blade.php ENDPATH**/ ?>